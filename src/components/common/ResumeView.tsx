...
// DATA //
import cvToDownload from "../../assets/Julienbouchez_CV_dev_05-2026_00.pdf";
      ...
      <Drawer direction={direction}>
        ...
        <DrawerContent className="data-[vaul-drawer-direction=bottom]:border-transparent">
          ...
          <div className="flex justify-center">
            <img
              src="https://res.cloudinary.com/dldc2n70y/image/upload/v1779958816/CV_dev_05-2026_SVG_gpu8j4.svg"
              alt="CV"

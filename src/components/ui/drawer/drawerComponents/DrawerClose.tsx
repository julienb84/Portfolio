...
const DrawerClose: React.FC<CloseProps> = ({
  children,
  className,
  variant = "outline",
  size = "lg",
  ...
  const variantClasses = {
    default: "bg-transparent text-app-content hover:bg-hovercolor",
    outline:
  ...
  return (
    <DrawerPrimitive.Close
      ...
      className={twMerge(
        `hidden md:inline-flex justify-center items-center border border-transparent rounded-sm bg-clip-padding text-sm font-medium whitespace-nowrap ${variantClasses[variant]} ${sizeClasses[size]} ${className}`,
      )}
    >
      {children}
    </DrawerPrimitive.Close>
